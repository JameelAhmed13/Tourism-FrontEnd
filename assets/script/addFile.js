...
// Tourist guide page auditors
$(document).ready(function() {
    var max_fields = 10; //maximum input boxes allowed
    var wrapper = $(".auditor-input-field"); //Fields wrapper
    var add_button = $(".add-auditor-field"); //Add button ID
    ...
    $(add_button).click(function(e) { //on add input button click
        ...
        if (x < max_fields) { //max input box allowed
            x++; //text box increment
            $(wrapper).append('<div class="row"><div class="col-md-6 my-2"> <label for="" class="form-label">Name</label> <input type="text" class="form-control" /> </div> <div class="col-md-6 my-2"> <label for="" class="form-label"> Address</label> <input type="text" class="form-control" /> </div> <a href="#" class="remove_field">Remove</a> </div>'); //add input box
        }
    });
